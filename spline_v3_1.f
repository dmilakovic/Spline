...
!====================================================================
      ...
      real*4, dimension(nint) :: x,ys,ye,sum,F
      integer i,j
      real*4 ispline, step, total
      real*4 z, zstart, zend, H
      external func
      real*4 func, gauss16
...
! n = integrate [F(z) H0*(1+z)^2/H(z)] dz
      ...
      zend=3.0
      H = 0
      H = gauss16(func,zstart,zend)
      write (*,*) 'H from gauss16:',H
      call qgaus(func,zstart,zend,H)
      write (*,*) 'H from qgaus:',H
      do i=1,4
         call trapzd(func,zstart,zend,H,i)
      end do
      write (*,*) 'H from trapzd:',H
! step 6: plot data
...
!======================================================================
      function func(x)
      real*4 f, x
      f = ((1+x)**2)/sqrt(0.27*(1+x)**3 + 0.73)!**(-0.5)
      return
      end function func
